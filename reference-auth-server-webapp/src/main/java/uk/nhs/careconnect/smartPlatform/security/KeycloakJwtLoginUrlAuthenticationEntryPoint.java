...
public class KeycloakJwtLoginUrlAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint {
    public KeycloakJwtLoginUrlAuthenticationEntryPoint(String loginFormUrl, String baseUrl) {
        super(loginFormUrl);
